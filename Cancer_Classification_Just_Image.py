##############################################################
### Classifying Skin Cancers Using Only Image Data
##############################################################
...
sizes = [Image_Size_x*Image_Size_y*(2*coloured+1), 20, 20, 20, 7] # Layers of the neural network. First and last are fixed, can change the hidden layers
