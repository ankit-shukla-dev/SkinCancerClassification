##############################################################
### Classifying Tumour Images for STAT 841
##############################################################
...
batch_size = 10000 # How many images in each batch from the training data
...
# Randomly sample directly from training set
# I didn't use this because it always converged to everything being guessed as nv

# net = Network(sizes)
# for batch in range(num_batches):
#     start_time = time.time()
#     # Train the network on the batch of tumours
#     np.random.shuffle(Train_Pics)
#     eta = etas[batch]
#     for tumour in Train_Pics[0:batch_size]:
#         net.point_train(tumour)
